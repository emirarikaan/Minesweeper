...
public class MayinTarlasi implements MouseListener {
  ...
  private ImageIcon image1=new ImageIcon(getClass().getResource("ant.png"));  
  private ImageIcon image2=new ImageIcon(getClass().getResource("flag.png"));  
...
public void mouseClicked(MouseEvent e) {
	...
	if(e.getButton()==1) {
		...
		if(b.isMine()) {
			JOptionPane.showMessageDialog(frame,"KARINCAAA");
			print();
		}
		else {
